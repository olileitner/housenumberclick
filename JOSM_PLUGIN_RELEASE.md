...
Use `RELEASE_STEPS.md` for GitHub release `v1.1.0`, then prepare migration/synchronization into the official JOSM plugin publication workflow to execute `ant publish` there.
